...
public class StatisticsApiTest {
     ...
     */
    @Test
    public void statisticsByFileExtensionTest() throws ApiException {
        String q = null;
        String dateAttr = null;
        ByFileExtensionFacet response = api.statisticsByFileExtension(q, dateAttr);
     ...
     */
    @Test
    public void statisticsByGroupOwnerTest() throws ApiException {
        String q = null;
        String dateAttr = null;
        ByGroupOwnerFacet response = api.statisticsByGroupOwner(q, dateAttr);
     ...
     */
    @Test
    public void statisticsByPrimaryNameTest() throws ApiException {
        String q = null;
        String dateAttr = null;
        ByPrimaryFacet response = api.statisticsByPrimaryName(q, dateAttr);
     ...
     */
    @Test
    public void statisticsBySecondaryStorageTest() throws ApiException {
        String q = null;
        String dateAttr = null;
        BySecondaryFacet response = api.statisticsBySecondaryStorage(q, dateAttr);
     ...
     */
    @Test
    public void statisticsBySizeTest() throws ApiException {
        String q = null;
        String dateAttr = null;
        BySizeFacet response = api.statisticsBySize(q, dateAttr);
     ...
     */
    @Test
    public void statisticsByUserOwnerTest() throws ApiException {
        String q = null;
        String dateAttr = null;
        ByUserOwnerFacet response = api.statisticsByUserOwner(q, dateAttr);
