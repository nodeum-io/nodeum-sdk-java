...
public class TaskExecutionsApi {
     ...
     */
    public okhttp3.Call indexTaskExecutionsCall(Integer limit, Integer offset, List<String> sortBy, String id, String taskId, String name, String type, String status, String logTime, String jobStarted, String jobFinished, String toProcessSize, String processedSize, String toProcessFiles, String processedFiles, String finalizedFiles, String estimationTime, String bandwidth, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call indexTaskExecutionsValidateBeforeCall(Integer limit, Integer offset, List<String> sortBy, String id, String taskId, String name, String type, String status, String logTime, String jobStarted, String jobFinished, String toProcessSize, String processedSize, String toProcessFiles, String processedFiles, String finalizedFiles, String estimationTime, String bandwidth, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = indexTaskExecutionsCall(limit, offset, sortBy, id, taskId, name, type, status, logTime, jobStarted, jobFinished, toProcessSize, processedSize, toProcessFiles, processedFiles, finalizedFiles, estimationTime, bandwidth, _callback);
        return localVarCall;
    ...
    public TaskExecutionCollection indexTaskExecutions(Integer limit, Integer offset, List<String> sortBy, String id, String taskId, String name, String type, String status, String logTime, String jobStarted, String jobFinished, String toProcessSize, String processedSize, String toProcessFiles, String processedFiles, String finalizedFiles, String estimationTime, String bandwidth) throws ApiException {
        ApiResponse<TaskExecutionCollection> localVarResp = indexTaskExecutionsWithHttpInfo(limit, offset, sortBy, id, taskId, name, type, status, logTime, jobStarted, jobFinished, toProcessSize, processedSize, toProcessFiles, processedFiles, finalizedFiles, estimationTime, bandwidth);
    ...
    public ApiResponse<TaskExecutionCollection> indexTaskExecutionsWithHttpInfo(Integer limit, Integer offset, List<String> sortBy, String id, String taskId, String name, String type, String status, String logTime, String jobStarted, String jobFinished, String toProcessSize, String processedSize, String toProcessFiles, String processedFiles, String finalizedFiles, String estimationTime, String bandwidth) throws ApiException {
        okhttp3.Call localVarCall = indexTaskExecutionsValidateBeforeCall(limit, offset, sortBy, id, taskId, name, type, status, logTime, jobStarted, jobFinished, toProcessSize, processedSize, toProcessFiles, processedFiles, finalizedFiles, estimationTime, bandwidth, null);
    ...
    public okhttp3.Call indexTaskExecutionsAsync(Integer limit, Integer offset, List<String> sortBy, String id, String taskId, String name, String type, String status, String logTime, String jobStarted, String jobFinished, String toProcessSize, String processedSize, String toProcessFiles, String processedFiles, String finalizedFiles, String estimationTime, String bandwidth, final ApiCallback<TaskExecutionCollection> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = indexTaskExecutionsValidateBeforeCall(limit, offset, sortBy, id, taskId, name, type, status, logTime, jobStarted, jobFinished, toProcessSize, processedSize, toProcessFiles, processedFiles, finalizedFiles, estimationTime, bandwidth, _callback);
        Type localVarReturnType = new TypeToken<TaskExecutionCollection>(){}.getType();
     ...
     */
    public okhttp3.Call indexTaskExecutionsByTaskCall(String taskId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call indexTaskExecutionsByTaskValidateBeforeCall(String taskId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = indexTaskExecutionsByTaskCall(taskId, _callback);
        return localVarCall;
    ...
    public TaskExecutionCollection indexTaskExecutionsByTask(String taskId) throws ApiException {
        ApiResponse<TaskExecutionCollection> localVarResp = indexTaskExecutionsByTaskWithHttpInfo(taskId);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<TaskExecutionCollection> indexTaskExecutionsByTaskWithHttpInfo(String taskId) throws ApiException {
        okhttp3.Call localVarCall = indexTaskExecutionsByTaskValidateBeforeCall(taskId, null);
        Type localVarReturnType = new TypeToken<TaskExecutionCollection>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call indexTaskExecutionsByTaskAsync(String taskId, final ApiCallback<TaskExecutionCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = indexTaskExecutionsByTaskValidateBeforeCall(taskId, _callback);
        Type localVarReturnType = new TypeToken<TaskExecutionCollection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call showTaskExecutionCall(Long taskExecutionId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call showTaskExecutionValidateBeforeCall(Long taskExecutionId, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call showTaskExecutionAsync(Long taskExecutionId, final ApiCallback<TaskExecution> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call showTaskExecutionByTaskCall(String taskId, Long taskExecutionId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call showTaskExecutionByTaskValidateBeforeCall(String taskId, Long taskExecutionId, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call showTaskExecutionByTaskAsync(String taskId, Long taskExecutionId, final ApiCallback<TaskExecution> _callback) throws ApiException {
