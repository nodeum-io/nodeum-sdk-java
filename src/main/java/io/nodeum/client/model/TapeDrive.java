...
public class TapeDrive {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(serial, scsiAddress, vendor, product, firmware, device, sgdevice, id, tapeLibraryId, name, comment, libso, acs, lsm, panel, transport, status, full, mountCount, useTo, useBy, useFileProcessedSize, useFileSizeToProcess, useFileNameProcessed, bandwidth);
  }
