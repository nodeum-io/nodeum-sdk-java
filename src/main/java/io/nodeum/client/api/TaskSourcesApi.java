...
public class TaskSourcesApi {
     ...
     */
    public okhttp3.Call indexTaskSourcesCall(String taskId, Integer limit, Integer offset, List<String> sortBy, String id, String fileId, String importFileId, String tapeId, String tapePoolId, String cloudPoolId, String nasPoolId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call indexTaskSourcesValidateBeforeCall(String taskId, Integer limit, Integer offset, List<String> sortBy, String id, String fileId, String importFileId, String tapeId, String tapePoolId, String cloudPoolId, String nasPoolId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = indexTaskSourcesCall(taskId, limit, offset, sortBy, id, fileId, importFileId, tapeId, tapePoolId, cloudPoolId, nasPoolId, _callback);
        return localVarCall;
    ...
    public TaskSourceCollection indexTaskSources(String taskId, Integer limit, Integer offset, List<String> sortBy, String id, String fileId, String importFileId, String tapeId, String tapePoolId, String cloudPoolId, String nasPoolId) throws ApiException {
        ApiResponse<TaskSourceCollection> localVarResp = indexTaskSourcesWithHttpInfo(taskId, limit, offset, sortBy, id, fileId, importFileId, tapeId, tapePoolId, cloudPoolId, nasPoolId);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<TaskSourceCollection> indexTaskSourcesWithHttpInfo(String taskId, Integer limit, Integer offset, List<String> sortBy, String id, String fileId, String importFileId, String tapeId, String tapePoolId, String cloudPoolId, String nasPoolId) throws ApiException {
        okhttp3.Call localVarCall = indexTaskSourcesValidateBeforeCall(taskId, limit, offset, sortBy, id, fileId, importFileId, tapeId, tapePoolId, cloudPoolId, nasPoolId, null);
     ...
     */
    public okhttp3.Call indexTaskSourcesAsync(String taskId, Integer limit, Integer offset, List<String> sortBy, String id, String fileId, String importFileId, String tapeId, String tapePoolId, String cloudPoolId, String nasPoolId, final ApiCallback<TaskSourceCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = indexTaskSourcesValidateBeforeCall(taskId, limit, offset, sortBy, id, fileId, importFileId, tapeId, tapePoolId, cloudPoolId, nasPoolId, _callback);
        Type localVarReturnType = new TypeToken<TaskSourceCollection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
