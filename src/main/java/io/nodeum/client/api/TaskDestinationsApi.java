...
public class TaskDestinationsApi {
     ...
     */
    public okhttp3.Call indexTaskDestinationsCall(String taskId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call indexTaskDestinationsValidateBeforeCall(String taskId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = indexTaskDestinationsCall(taskId, _callback);
        return localVarCall;
    ...
    public TaskDestinationCollection indexTaskDestinations(String taskId) throws ApiException {
        ApiResponse<TaskDestinationCollection> localVarResp = indexTaskDestinationsWithHttpInfo(taskId);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<TaskDestinationCollection> indexTaskDestinationsWithHttpInfo(String taskId) throws ApiException {
        okhttp3.Call localVarCall = indexTaskDestinationsValidateBeforeCall(taskId, null);
     ...
     */
    public okhttp3.Call indexTaskDestinationsAsync(String taskId, final ApiCallback<TaskDestinationCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = indexTaskDestinationsValidateBeforeCall(taskId, _callback);
        Type localVarReturnType = new TypeToken<TaskDestinationCollection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
